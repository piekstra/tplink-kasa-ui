...
@router.get('/api/power/devices/current', response_model=DevicesPowerCurrentResponse)
...
@router.get('/api/power/devices/day', response_model=DevicesPowerDayResponse)
...
@router.get('/api/power/devices/month', response_model=DevicesPowerMonthResponse)
